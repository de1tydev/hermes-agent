...
required_environment_variables:
  - name: BAIDU_API_KEY
    prompt: Baidu AppBuilder API key
metadata:
  hermes:
    tags: [Baidu, Baike, Search]
---
...
```bash
python3 {baseDir}/scripts/baidu_baike.py --search_type=lemmaTitle --search_key="keyword"
```
...
python3 {baseDir}/scripts/baidu_baike.py --search_type=lemmaList --search_key="keyword" --top_k=5

# Get specific entry by ID
python3 {baseDir}/scripts/baidu_baike.py --search_type=lemmaId --search_key="entry_id"
```
