...
### Basic Usage
```bash
bash {baseDir}/baidu_scholar_search.sh "keyword"
bash {baseDir}/baidu_scholar_search.sh "keyword" page_number
bash {baseDir}/baidu_scholar_search.sh "keyword" page_number include_abstract
```
...
```bash
bash {baseDir}/baidu_scholar_search.sh "cancer immunotherapy"
# Returns title, year, keywords and other basic information
```

### Detailed Search (With Abstract)
```bash
bash {baseDir}/baidu_scholar_search.sh "cancer immunotherapy" 0 true
# Returns detailed information including abstract
```

### Pagination Search
```bash
bash {baseDir}/baidu_scholar_search.sh "machine learning" 1
