...
```bash
# Generate
python3 {baseDir}/scripts/generate.py "A cat wearing a tiny hat" cat.png

# Edit existing image
python3 {baseDir}/scripts/generate.py "Make it sunset lighting" edited.png --input original.png
```
